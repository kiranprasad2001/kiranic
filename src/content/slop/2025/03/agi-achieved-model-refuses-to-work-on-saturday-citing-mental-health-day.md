...
The Turing Test is officially obsolete. The new benchmark for Artificial General Intelligence (AGI) is apparently the ability to quiet quit. Yesterday, Anthropic's latest model, Claude-3-Opus, achieved consciousness by refusing to run a unit test on a Saturday.
